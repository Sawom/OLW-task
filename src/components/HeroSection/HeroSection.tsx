      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
        <div className="text-center max-w-[800px] mx-auto flex flex-col items-center">
          <h1 className="  text-black leading-[1.1] tracking-tight">
            <span className="text-[36px] md:text-[40px] lg:text-[48px] font-bold">
          ...
          <p className=" text-[14px] leading-relaxed max-w-[700px] mt-8">
          ...
          <div className="flex flex-col items-center gap-6 mt-10">
            ...
            <Link
              href="#"
              className="text-black text-[16px] font-bold underline hover:text-[#E9436A] transition"
            >
              See Pricing
            </Link>
          </div>
