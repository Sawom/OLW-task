      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:block">
            <button className="flex cursor-pointer items-center gap-2 bg-[#E9436A] text-white px-6 py-2.5 rounded-lg font-semibold text-[15px] hover:opacity-90 transition active:scale-95">
